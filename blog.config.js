const BLOG = {
  title: 'TANXY',
  author: 'Issac Tan',
  email: '1486973169tan@gmail.com',
  link: 'https://tanxynotion.vercel.app',
  ...
  socialLink: 'https://twitter.com/Tan35899992',
  seo: {
    keywords: ['Blog', 'Website', 'Notion','tanxy'],
  ...
  comment: {
    ...
    cusdisConfig: {
      appId: 'd21d45c6-d083-43f4-8898-fe11decf7e3d', // data-app-id
